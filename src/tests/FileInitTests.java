...
public class FileInitTests {
	// Constants that I will use to test whether the file was loaded correctly
		...
		public static void setUp() {
			System.out.println("FileInitTests test");
		...
		public void FourDoorDirections() {
			...
			cell = board.getCell(16, 6);
			assertTrue(cell.isDoorway());
			assertEquals(DoorDirection.DOWN, cell.getDoorDirection());
			// Test that walkways are not doors
			cell = board.getCell(13, 15);
		...
		public void testRooms() {
			...
			BoardCell cell = board.getCell( 21, 20);
			Room room = board.getRoom( cell ) ;
			assertTrue( room != null );
			assertEquals( room.getName(), "Mancave" ) ;
			...
			assertTrue( room != null );
			assertEquals( room.getName(), "Panic Room" ) ;
			...
			room = board.getRoom( cell ) ;
			assertTrue( room != null );
			assertEquals( room.getName(), "Food Hall" ) ;
